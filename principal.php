    ...
    <body id="miBody" style="<?php echo $theme; ?>">
        <div class="container" style="width:100%" >
            <div class="page-header">
                ...
                echo "<a class='btn btn-info animated bounceInLeft' href='#' onclick='MostrarGrillaEliminados()' " . (($objUser->perfil != "administrador")? "style ='display:none'" : "") . "><span class='glyphicon glyphicon-warning-sign'>&nbsp;</span>Grilla Eliminados&nbsp;</a>";
